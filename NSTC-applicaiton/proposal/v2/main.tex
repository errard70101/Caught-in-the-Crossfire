...
This project therefore asks how external uncertainty shocks from the United States, China, and the global economy operate in Taiwan, and which structural friction explains their macroeconomic effects. It answers this question by moving from \emph{source}, to \emph{channel}, to \emph{mechanism}. Year 1 identifies the source and reduced-form transmission channel of external uncertainty by estimating Taiwan's macroeconomic and financial uncertainty factors and by classifying external drivers according to their time-varying association with these factors. Year 2 provides the structural mapping by deriving how competing mechanisms, including collateral constraints, risk-premium channels, working-capital frictions, and small-open-economy trade or input-finance channels, should appear in Business Cycle Accounting wedges. Year 3 validates the mechanism empirically by constructing Taiwan's BCA wedges and testing which wedge signature best matches the response to the uncertainty shocks identified in Year 1.
...
\textbf{Wedge projection and MCMC-integrated validation.} Reduced-form classification cannot by itself distinguish competing structural frictions (C4). Year~2 derives a wedge-projection framework that maps uncertainty-related second-moment risk corrections in a nonlinear structural model into Business Cycle Accounting wedges, converting transmission-channel evidence into testable structural predictions: collateral and risk-premium mechanisms should load primarily on the investment wedge, while working-capital mechanisms should load primarily on the after-tax labor wedge. Year~3 then estimates wedge-level local projections that take the full posterior distribution of the Year~1 uncertainty factors as input. By propagating first-stage posterior uncertainty into the structural test rather than relying on a point estimate, this MCMC-integrated design closes the residual two-step bias of C3 and yields a coherent end-to-end inference path.
...
The project also produces three year-specific contributions. The \textbf{first-year contribution} is \emph{empirical identification}: the project constructs a monthly Taiwan external-uncertainty dataset, estimates Taiwan-specific macroeconomic and financial uncertainty factors, and computes time-varying classification probabilities for each external driver. The \textbf{second-year contribution} is \emph{theoretical mapping}: the project derives wedge signatures for collateral, risk-premium, and working-capital frictions in a small-open-economy environment, clarifying how each friction should appear in the investment, labor, efficiency, and external wedges. The \textbf{third-year contribution} is \emph{empirical validation}: the project constructs Taiwan's BCA wedges and uses the MCMC-integrated wedge-level local projections to test which structural signature best matches the reduced-form transmission patterns identified in Year~1.
...
The third year produces the integrated empirical test. Its main deliverables are (a) Taiwan's BCA wedges constructed from national accounts data; (b) wedge-level local projections estimated with the MCMC-integrated design, in which the full posterior distribution of the Year~1 uncertainty factors is passed in as the right-hand-side regressor; (c) a comparative mechanism indicator---posterior odds or Bayesian model averaging weights---ranking the three competing frictions against Taiwan's data; and (d) policy interpretation that connects the winning mechanism to specific instruments, such as asset-price and credit-market policy for collateral and risk-premium channels and short-term liquidity support for working-capital channels. The third-year estimation therefore depends on Year~1's posterior draws and on Year~2's wedge-signature hypotheses, and the project schedule places it only after both inputs are available.
